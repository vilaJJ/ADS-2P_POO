package dev.mandevilla.bancomonetario2.Banco.Components.Conta;
...
import dev.mandevilla.bancomonetario2.Banco.Components.Conta.Components.Extrato.Extrato;
import dev.mandevilla.bancomonetario2.Banco.Components.Conta.Enums.TipoConta;
import dev.mandevilla.bancomonetario2.Banco.Components.Conta.Enums.TipoOperacao;
import dev.mandevilla.bancomonetario2.Banco.Components.Conta.Interfaces.IConta;
...
public class Conta implements IConta {
    ...
    public boolean realizarTransferencia(String cpf_cnpj_destinatario, String numeroConta_destinatario, float value) {
        var clienteDestinatario = banco.obterCliente(cpf_cnpj_destinatario);
        var contaDestinatario = banco.obterConta(clienteDestinatario, numeroConta_destinatario);
